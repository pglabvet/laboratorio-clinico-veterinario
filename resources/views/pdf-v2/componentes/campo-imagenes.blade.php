{{-- Componente PDF V2: Campo de Imágenes (diseño limpio) --}}
...
<div class="images-container">
    ...
    <div class="image-cell">
        ...
        @if($imagenBase64_1)
            ...
            <p style="font-size: 7px; color: #718096; margin-top: 4px;">Imagen 1</p>
        @endif
    </div>
    @endif
    ...
    <div class="image-cell">
        ...
        @if($imagenBase64_2)
            ...
            <p style="font-size: 7px; color: #718096; margin-top: 4px;">Imagen 2</p>
        @endif
    </div>
    @endif
</div>
