...
<head>
    ...
    <title>Historial de Movimientos - LabVet</title>
    ...
    <flux:sidebar sticky stashable class="bg-neutral-50 dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-700">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group expandable heading="Inventario" icon="cube">
                ...
                <flux:navlist.item href="{{ route('inventario.salidas') }}">Salidas Manuales</flux:navlist.item>
                <flux:navlist.item href="{{ route('inventario.historial') }}" current>Historial</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
