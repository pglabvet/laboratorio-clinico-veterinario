            ...
            <div class="flex-1">
                ...
                <flux:subheading class="mt-1 text-xs">
                    @if($analisisEnRevision > 0)
                        <span class="text-orange-600 dark:text-orange-400">Esperando revisión</span>
                    @else
                        <span class="text-green-600 dark:text-green-400">Todo revisado</span>
                    @endif
                </flux:subheading>
            </div>
            <div class="rounded-lg {{ $analisisEnRevision > 0 ? 'bg-orange-100 dark:bg-orange-900/20' : 'bg-green-100 dark:bg-green-900/20' }} p-3 transition-transform group-hover:scale-110">
                <svg class="size-6 {{ $analisisEnRevision > 0 ? 'text-orange-600 dark:text-orange-400' : 'text-green-600 dark:text-green-400' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
