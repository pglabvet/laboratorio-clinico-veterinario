...
<div 
    ...
    x-data="{
        ...
        esFueraDeRango(fila) {
            if (fila.tipo_fila !== '3col' || !fila.resultado) return false;
                    ...
                    @else
                        ...
                        <td class="border border-gray-300 dark:border-zinc-700 px-1 py-1">
                            <input 
                                ...
                                :class="esFueraDeRango(filas[{{ $i }}]) ? 'text-red-600 dark:text-red-400 font-bold' : 'text-gray-900 dark:text-zinc-100'"
