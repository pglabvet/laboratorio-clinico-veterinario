...
x-init="$watch('contenido', () => enviarDatos())"
    ...
    @if(($componente['propiedades']['formato'] ?? 'parrafos') === 'lista')
        ...
        <div class="space-y-1">
            ...
            <textarea 
                ...
                x-model="contenido"
                @blur="enviarDatos()"
                placeholder="Escribe cada item en una línea diferente&#10;Item 1&#10;Item 2&#10;Item 3"
    ...
    @else
        ...
        <div>
            ...
            <textarea 
                ...
                x-model="contenido"
                @blur="enviarDatos()"
                placeholder="Escriba el texto libre aquí. Puede incluir múltiples párrafos..."
