        ...
        <div class="p-4 border-b border-neutral-200 dark:border-neutral-700">
            <div class="flex flex-col gap-3">
                ...
                <div x-data="{
                    ...
                    get filtrosActivos() {
                        let count = 0;
                        if ($wire.busquedaSalidas) count++;
                        if ($wire.filtroSucursal) count++;
                        if ($wire.fechaDesdeSalidas) count++;
                        if ($wire.fechaHastaSalidas) count++;
                        return count;
                    }
                }">
                    {{-- Toggle móvil --}}
                    ...
                    <div x-show="mostrarFiltros"
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-end gap-3">
                            ...
                            <div class="w-full sm:w-auto">
                                <flux:input type="date" wire:model.live="fechaDesdeSalidas" label="Desde" />
                            </div>
                            {{-- Hasta --}}
                            <div class="w-full sm:w-auto">
                                <flux:input type="date" wire:model.live="fechaHastaSalidas" label="Hasta" />
                            </div>
                            {{-- Sucursal --}}
                            <div class="w-full sm:w-auto">
                                <flux:dropdown>
