    ...
    @else
        <div class="p-3 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-800">
            ...
            <ul class="text-xs text-blue-700 dark:text-blue-300 space-y-1 ml-4 list-disc">
                <li>Crea un <strong>campo de texto individual</strong>. El bioquímico escribirá el valor al capturar resultados.</li>
                <li>El título aparecerá como encabezado del campo en el formulario y en el PDF.</li>
            </ul>
        </div>
    @endif
</div>
